...
def run_test(model_fname, agent_env_args, action_repeat):
    worker_id = os.getpid()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--action-repeat', dest='action_repeat', type=int, default=1)
    parser.add_argument('--stepsize', dest='step_size', type=float, default=0.01)
    ...
    agent_env_args = dict(
        step_size=args.step_size, visualize=args.visualize, # OsimEnv
    ...
    test_results = [pool.apply_async(run_test, (args.model, agent_env_args, args.action_repeat)) 
